<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" type="primary" size="medium" icon="el-icon-search" @click="getList">
        搜索
      </el-button>
      <el-button v-if="permStatus.add" type="primary" size="medium" class="filter-item" icon="el-icon-edit" @click="handleCreate">
        新增
      </el-button>
    </div>
